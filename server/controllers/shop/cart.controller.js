...
const addToCart = async (req, res) => {
    try {
        ...
        if (!cart) {
            // ! creating a new cart object - If doesn't exist already
        ...
        // ! Save The Object to the Database - Important Method 
        await cart.save();
...
const fetchCartItems = async (req, res) => {
    try {
        ...
        // ! Checking If item is still Present Or Deleted by the admin - Simulate This scenerio
        ...
        // ! Populating the cart items - How and Why is this working...
