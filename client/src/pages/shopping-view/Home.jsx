...
const ShoppingHome = () => {
  ...
  function handleNavigateToListingPage(getCurrentItem, section) {
    ...
    // ! See The Logic Of Filtering Products 
    // ! Dynamically, Creating, filter objects
    const currentFilter = {
  ...
  // ! Important Function - Add To Cart
  ...
  // ! Fetch Only Featured Products - Froom Admin Panel
  useEffect(() => {
    dispatch(
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 bg-gray-300 text-background">
            ...
            {categoriesWithIcon.map((categoryItem) => (
              ...
              >
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  {/* // ! Accessing HTML Tag Dynamically */}
      ...
      <section className="py-12 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {/* // ! Fetch Featured Products, Dynamically From Admin Panel */}
            {productList && productList.length > 0
              ? productList.map((productItem) => (

                // ! Create A Custom Component For Featured Product Tile
                <ProductTile
